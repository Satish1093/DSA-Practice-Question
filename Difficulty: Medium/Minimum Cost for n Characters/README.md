<h2><a href="https://www.geeksforgeeks.org/problems/minimum-time1238/1?_gl=1*1u9346w*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw9-PNBhDfARIsABHN6-1cB9WUneolO9cpN8SagYOEHmk5U9zm0CYe4IZe_GnNy9LaCsdtV-0aAlPCEALw_wcB&gbraid=0AAAAAC9yBkCEP5oDxTI9F5gV3dKKgpOmT">Minimum Cost for n Characters</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given four integers <strong>n</strong>, <strong>i</strong>, <strong>d</strong>, and <strong>c</strong>, where:</span></p>
<ul>
