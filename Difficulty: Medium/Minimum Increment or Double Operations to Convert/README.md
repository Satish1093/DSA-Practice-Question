<h2><a href="https://www.geeksforgeeks.org/problems/minimum-steps-to-get-desired-array5519/1?_gl=1*bfhaet*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw9-PNBhDfARIsABHN6-1cB9WUneolO9cpN8SagYOEHmk5U9zm0CYe4IZe_GnNy9LaCsdtV-0aAlPCEALw_wcB&gbraid=0AAAAAC9yBkCEP5oDxTI9F5gV3dKKgpOmT">Minimum Increment or Double Operations to Convert</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18.6667px;">Given an array <strong>arr[]</strong>. Initially, you have another array containing only 0s.<br></span><span style="font-size: 18.6667px;">In one operation, you may either:</span></p>
<ul>
