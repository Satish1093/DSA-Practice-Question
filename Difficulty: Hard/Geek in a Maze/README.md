<h2><a href="https://www.geeksforgeeks.org/problems/geek-in-a-maze--170637/1?_gl=1*1g6okwc*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw9-PNBhDfARIsABHN6-1cB9WUneolO9cpN8SagYOEHmk5U9zm0CYe4IZe_GnNy9LaCsdtV-0aAlPCEALw_wcB&gbraid=0AAAAAC9yBkCEP5oDxTI9F5gV3dKKgpOmT">Geek in a Maze</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p data-start="571" data-end="632"><span style="font-size: 14pt;">Given a maze <strong>mat[][]</strong> of size<strong> n × m</strong>, where each cell is either:</span></p>
<ul>
