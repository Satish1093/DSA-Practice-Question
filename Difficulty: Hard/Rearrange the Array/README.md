<h2><a href="https://www.geeksforgeeks.org/problems/rearrange-the-array-1639032648/1?_gl=1*gi8iz0*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw9-PNBhDfARIsABHN6-1cB9WUneolO9cpN8SagYOEHmk5U9zm0CYe4IZe_GnNy9LaCsdtV-0aAlPCEALw_wcB&gbraid=0AAAAAC9yBkCEP5oDxTI9F5gV3dKKgpOmT">Rearrange the Array</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Consider an array<strong> </strong></span><span style="font-size: 18px;"><strong>a[]</strong> = [1, 2, 3, ..., n] and a permutation <strong>b[]</strong> of size n containing all integers from 1 to n exactly once.</span></p>
<ul>
